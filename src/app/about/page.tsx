...
export default function AboutPage() {
  return (
    <>
      <Header />
      <main>
        {/* Hero Section - No background image, bigger WHO IS TAMARA */}
        <section className="relative min-h-[60vh] flex items-center bg-matte-black overflow-hidden">
          <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-32 pb-20 w-full">
            ...
            >
              {/* Bigger WHO IS TAMARA */}
              <motion.h1
                variants={staggerItem}
                className="text-gold font-playfair tracking-wider uppercase mb-8 text-4xl md:text-6xl lg:text-7xl"
              >
                Who Is Tamara?
              </motion.h1>
        ...
        {/* Combined Brooklyn story with "From Survival Mode" header */}
        ...
        {/* Create Your Own Runway Program - Bigger label, smaller title */}
        <section className="py-20 bg-matte-black text-center">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              <motion.p
                variants={staggerItem}
                className="text-cream-white/70 uppercase tracking-wider mb-4 text-lg md:text-xl"
              >
        ...
        {/* Award Winning Speaker Banner - Bigger text, crown icons */}
        <section className="py-16 bg-gold">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            >
              {/* Crown icon left - Use large crown logo */}
              <Image
                src="/logo/Tamara FG_Logo_CROWN_Large.png"
                alt="Crown"
                width={60}
                height={60}
              ...
              {/* Crown icon right - Use large crown logo */}
              <Image
                src="/logo/Tamara FG_Logo_CROWN_Large.png"
                alt="Crown"
                width={60}
        ...
        {/* Mission Section - Bigger TAMARA'S GOAL, line break, new image */}
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
              <motion.div
                ...
                className="space-y-6"
              >
                {/* Bigger with line accents like Industry Accolades */}
                <motion.div
                  variants={staggerItem}
        ...
        {/* CTA Section - New text, new button label */}
        <section className="py-20 bg-gold">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <motion.div
              ...
              viewport={scrollTrigger}
            >
              {/* Added "Dream It • Design It • Do It" - bigger with more spacing */}
              <motion.p
                variants={staggerItem}
                className="text-white font-medium mb-6 text-2xl md:text-3xl"
              >
